...
<!-- header section end-->
<button class="back" onclick="document.location='logged.php'"> Back </button>
...
<?php
    ...
    ?>
            ...
            <form method="post" action="">
                ...
                <button type="submit" name="submitPayment" onclick=confirm_payment()>Confirm Payment</button>
            </form>
            </div>
